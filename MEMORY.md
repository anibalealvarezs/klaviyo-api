...
- Purpose: This package operates within the Communication (SDKs) layer of the APIs Hub SaaS hierarchy, providing Klaviyo API client functionality.
- Dependency stance: Consumes `anibalealvarezs/api-client-skeleton` and serves the `klaviyo-hub-driver`.
## Local working rules
...
## Current notes
- Klaviyo client is the source-facing SDK for the Klaviyo driver.